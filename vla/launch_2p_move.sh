...
S="${S:-/tmp/claude-1000/-home-itri/d5bcb745-73d7-40b1-b6fd-803777c86ae4/scratchpad}"
...
setsid nohup /home/itri/anaconda3/envs/env_isaaclab/bin/python mir_isaac_sim.py \
  ...
  --world /home/itri/mir_isaac_test/scenes/follow_room_2p_v2.usd \
  --top-down --top-down-height 22 \
  > "$S/isaac_2p_move.log" 2>&1 < /dev/null &

echo "Isaac starting; give it ~100 s, then check:"
echo "  grep -a 'person walk on\\|corner camera\\|global camera' $S/isaac_2p_move.log"
